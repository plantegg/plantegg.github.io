...
这块参考[阿里云文档](https://help.aliyun.com/document_detail/102087.html?spm=a2c4g.11186623.6.721.4a732223pEfyNC)
...
升级内核带来的性能提升只是在极端场景下才会需要，大部分时候我们希望节省开发人员的时间，提升工作效率。
...
如下测试中11万的tps是解决掉锁后得到的，4万tps是没解决锁等待前的tps：
...
这行命令得到如下等锁的top 10堆栈（[async-profiler](https://github.com/jvm-profiling-tools/async-profiler)）：
...
最终在 @梁希 同学的攻关下问题基本都解决了。不但tps提升明显，rt也有很大的下降。
