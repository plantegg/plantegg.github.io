...
此处可以设置固定上限，对每内核每秒处理中断数量的最大值进行硬性限制，或针对特定硬件根据吞吐率[自动调整中断速率](https://community.mellanox.com/docs/DOC-2511)。
...
![image-20221125190002856](/images/951413iMgBlog/image-20221125190002856.png)
