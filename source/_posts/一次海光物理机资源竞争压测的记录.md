...
![img](/Users/ren/src/blog/951413iMgBlog/8faf9b906427972cb59ac4332d41d8a4.png)

海光其产品规格如下，产品相对密集，但是产品之间差异化很小，频率总体接近。

![img](/Users/ren/src/blog/951413iMgBlog/bad3d840f2d5017c50b77d47d4292eef.png)
...
![img](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/neweditor/64118c14-da63-4775-abd3-a4f86ec84cf5.png)
...
![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/595bc15fdd72860f2d1875c86384a14b.png)
...
![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/7aea9045e50794fadc0439ee806f2496.png)

![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/86c3f14887345a1d5f08cae985816564.png)

**从以上截图，可以看到关键的 insn per cycle 能到0.51和0.66（这个数值越大性能越好）**

如果同时压物理机上的所有服务节点

![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/02f47474c612c2bf6e612efea3ab5de3.png)

![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/c3d90e077d00a7a3db54770d9eea2dbb.png)
...
![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/f6882f4c671b4c4b46feb01aa5e272fd.png)
...
![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/f86cd786f3a8297078579b547f78ec81.png)

对比下intel的 Xeon 104core，也是物理52core，但是性能呈现完美线性

![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/8086f47b955d8d951e4dd4c7fe5e135e.png)

### openssl场景多核能力验证

据说海光的一个core只有一个fpu，所以超线程算除法完全没用，那么我们再来跑一组openssl 加密

> openssl speed aes-256-ige -multi N

intel 52 VS 26，可以看到52个线程的性能大概是26个的1.8倍

![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/4534d8e5901cc812aa54e610d1386445.png)

intel 104 VS 52 线程，性能还能提升1.4倍

![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/6583f52e03b9753969e52d6a8b211725.png)

海光32 VS 16, 性能能提升大概1.8倍，跟intel一致

![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/41e7f230ec27653c1b5ae5287971cd3a.png)

海光64 VS 32, 性能能提升大概1.2倍

![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/2ad45a252392a06fa64d7475848e5601.png)
...
![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/be30ab94eddc37f1d90c53204a0ed215.png)

### 用Sysbench直接压MySQL oltp_read_only的场景

![image.png](https://ata2-img.oss-cn-zhangjiakou.aliyuncs.com/89c7a0228c45f79b688710206ba9d414.png)
