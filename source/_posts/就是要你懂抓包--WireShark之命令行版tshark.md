...
![image.png](https://plantegg.oss-cn-beijing.aliyuncs.com/images/oss/1fc544dcd6e064f967481472f6688be9.png)
...
![image.png](https://plantegg.oss-cn-beijing.aliyuncs.com/images/oss/d99665729dbc0ccbcbebd5176900ce6c.png)

** 问题修复后数据库每个查询的平均响应时间从47毫秒下降到了4.5毫秒 **

![image.png](https://plantegg.oss-cn-beijing.aliyuncs.com/images/oss/3a80fa647b634e1671a0ebfd40a468bd.png)

#### 从wireshark中也可以看到类似的rtt不正常（超过150ms的比较多）
![image.png](https://plantegg.oss-cn-beijing.aliyuncs.com/images/oss/52cb9d61ce948f9b64737b7be88ac84e.png)

#### 从wireshark中也可以看到类似的rtt正常(99%都在10ms以内）

![image.png](https://plantegg.oss-cn-beijing.aliyuncs.com/images/oss/196033f267c33c08a4ca6b6fdb957cf3.png)
