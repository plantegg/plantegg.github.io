...
![undefined](https://intranetproxy.alipay.com/skylark/lark/0/2019/png/33359/1562207744743-e86e37bb-c8e4-40aa-b581-ac862011221a.png) 
...
![image.png](https://ata2-img.cn-hangzhou.oss-pub.aliyun-inc.com/45b484a77965974c20faa9d034b734f4.png)

![image.png](https://ata2-img.cn-hangzhou.oss-pub.aliyun-inc.com/5c03818e5fab6431a709753130be5897.png)

用户线程读取分成两步，用户线程先发起select调用（确认内核是否准备好数据），准备好后才调用read，将数据从内核空间读取到用户空间（read这里还是阻塞）。主要是一个select线程可以向内核查多个数据通道的状态

![undefined](https://intranetproxy.alipay.com/skylark/lark/0/2019/png/33359/1562207798044-84e66820-3cbf-4353-9b5b-1dd1124631df.png) 
...
![undefined](https://intranetproxy.alipay.com/skylark/lark/0/2019/png/33359/1562210988218-8e4dfbae-8947-4bc6-93c7-8e0157637d6c.png) 

Select 触发 read/write 逻辑： 
...
![undefined](https://intranetproxy.alipay.com/skylark/lark/0/2019/png/33359/1562208003461-4226b646-8ad8-4d86-abac-d6e6601ece88.png) 
...
![image.png](https://ata2-img.cn-hangzhou.oss-pub.aliyun-inc.com/090682cb3deeb9a35a9dfad06b88e288.png)
...
![image.png](https://ata2-img.cn-hangzhou.oss-pub.aliyun-inc.com/167657b454322840ae3a4204781f1bf5.png)
...
![image.png](https://ata2-img.cn-hangzhou.oss-pub.aliyun-inc.com/9a90497373211d65186a2a256212e3bf.png)

从协程 1 切换到协程 2 后的状态如下图所示：

![image.png](https://ata2-img.cn-hangzhou.oss-pub.aliyun-inc.com/0d997ee52fd79d752d1af9636ac6c858.png)
...
![image.png](https://ata2-img.cn-hangzhou.oss-pub.aliyun-inc.com/7ece6c553c78927c7886f70c09d7e15b.png)
