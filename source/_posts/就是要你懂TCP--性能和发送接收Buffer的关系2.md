...
![image.png](/images/d188530df31712e8341f5687a960743a.png)

粗一看没啥问题，因为时间太长掩盖了问题。把这个图形放大，只看中间50ms内的传输情况（横轴是时间，纵轴是sequence number，一个点代表一个包）

<img src="/images/e177d59ecb886daef5905ed80a84dfd2.png" alt="image.png" style="zoom: 80%;" />

换个角度，看看窗口尺寸图形：

![image.png](/images/7ae26e844629258de173a05d5ad595f9.png)
...
![image.png](/images/d385a7dad76ec4031dfb6c096bca434b.png)

（图片[来自][5]）

![image.png](/images/ff025f076a4a2bc2b1b13d11f32a97d3.png)
...
![image.png](/images/3d9e77f8c9b0cab1484c870d2c0d2473.png)
...
![image.png](/images/3dcfd469fe1e2f7e1d938a5289b83826.png)
...
![image.png](/images/4af4765c045e9eed2e36d9760d4a2aba.png)

基本可以看到server一旦空出来点窗口，client马上就发送数据，由于这点窗口太小，rtt是40ms，也就是一个rtt才能传3456字节的数据，整个带宽才用到80-90K，完全没跑满。

![image.png](/images/1984258c0300921799476777f5f0a38a.png)

比较明显间隔 40ms 一个等待台阶，台阶之间两个包大概3K数据，总的传输效率如下：

![image.png](/images/5ec50ecf25444e96d81fab975b5a79e6.png)

**斜线越陡表示速度越快，从上图看整体SQL上传花了5.5秒，执行0.5秒。**

此时对应的窗口尺寸：

![image.png](/images/05d6357ed53c1c16f0dd0454251916ef.png)
...
![image.png](/images/da48878ce0c01bcdedb1e6d6a6cc6d1c.png)
...
![image.png](/images/49e2635a7c4025d44b915a1f17dd272a.png)
...
![image.png](/images/2e493d8dc32bb63f2126375de6675351.png)
...
![image.png](/images/d7d3af2c03653e6cf8ae2befa0022832.png)

绿线是最大接收窗口动态调整的过程，最开始是1460\*10，握手完毕后略微调整到1472*10（可利用body增加了12），随着数据的传输开始跳涨

![image.png](/images/d0e12e8bad8764385549f9b391c62ab0.png)
...
![image.png](/images/259767fb17f7dbffe7f77ab059c47dbd.png)

从这里可以看到Nginx大概在60ms内就将4M的数据都发完了

### client上抓包

![image.png](/images/466fba92829f6a922ccd2d57a7e3fdac.png)
...
![image.png](/images/93e254c5154ce2e065bec9fb34f3db2b.png)

![image.png](/images/0a8c68a58da6f169573b57cde0ffba93.png)

接着看一下client上的抓包

![image.png](/images/822737a4ed6ffe6b920d4b225a1be5bf.png)

可以清楚看到 client的接收窗口是64K， 64K*1000/150=426K 这个64K很明显是16位的最大值，应该是TCP握手有一方不支持window scaling factor

那么继续分析一下握手包，syn：

![image.png](/images/004886698ddbaa1cbc8342a9cd667c76.png)

说明client是支持的，再看 syn+ack：

![image.png](/images/70155e021390cb1ee07091c306c375f4.png)
...
![image.png](/images/a08a204ec7ad4bba7867dacea1668322.png)
...
![image.png](/images/d56f87a19a10b0ac9a3b7009641247a0.png)

抓包来分析原因：

![image.png](/images/d5e2e358dd1a24e104f54815c84875c9.png)

实际看到大量的response都是3.5ms左右，符合我们的预期，但是有少量rt被delay ack严重影响了

从下图也可以看到有很多rtt超过3ms的，这些超长时间的rtt会最终影响到整个服务rt

![image.png](/images/48eae3dcd7c78a68b0afd5c66f783f23.png)
...
![image.png](/images/ea04e40acda986675bf0ad0ea7b9b8ff.png)
