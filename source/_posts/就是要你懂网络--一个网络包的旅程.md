...
![image.png](/images/oss/d37028807148f8ec630512bdd4223335.png)

上面的概念在[RFC1180](https://tools.ietf.org/html/rfc1180 )中讲的无比的通熟易懂和连贯，但是抱歉，当时你也许看懂了，但是一个月后又忘记了，或者碰到问题才发现之前即使觉得看懂了的东西实际没懂，我发现大多人看 RFC1180、教科书基本当时都能看到，但就是一到实践就不会了，这里的鸿沟我分析应该就是缺少实践认知。
...
![Host to Host through a Switch - Switch Functions animation](/images/951413iMgBlog/gif/packtrav-host-switch-host.gif)
...
![image.png](/images/oss/8f5d8518c1d92ed68d23218028e3cd11.png)
...
![image.png](/images/oss/510e9ea924b0b9d73f3fb556b25f3c1c.png)
...
同时观察到的不正常延时：
![image.png](/images/oss/5639309276cbbb44e8dfd9f1dd207555.png)
...
![undefined](/images/oss/1561010762561-4a8510f9-db2f-44bd-b86f-ddfc5bc889d3.png) 	
...
![image.png](/images/oss/e6fb91ba3d0c1b309295bff49730594e.png)
...
![image.png](/images/oss/c9d5ff245eac6a023acd7148b7676b4f.png)
...
[Computer Networking Introduction - Ethernet and IP (Heavily Illustrated)](https://iximiuz.com/en/posts/computer-networking-101/) 这篇凑合吧，其实没我这篇写得好，不过这个博客还有些别的文章也不错
